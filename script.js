...
tl.from("#line1-part1, .line h2", {
  opacity: 0,
  onStart: function () {
    var loadTimer = document.querySelector("#line1-part1 h5");
    var grow = 0;
...
function projectAnimation() {
  Shery.imageEffect(".image-div", {
    ...
    config: {
      ...
      aspect: { value: 0.7272615665464809 },
...
document.querySelector("#footer-div h1").addEventListener("mouseover",function(){
      $('#footer-div h1').textillate({ in: { effect: 'fadeIn' } });
})
